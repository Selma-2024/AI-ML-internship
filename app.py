...
@st.cache_resource
def load_model(format_type: str = "joblib") -> Any:
...
with col1:
    ...
    sepal_length = st.slider(
        ...
        value=float(feature_ranges["sepal_length"].get("default", 5.8)),
        step=0.1,
    ...
    sepal_width = st.slider(
        ...
        value=float(feature_ranges["sepal_width"].get("default", 3.0)),
        step=0.1,
    ...
    petal_length = st.slider(
        ...
        value=float(feature_ranges["petal_length"].get("default", 4.0)),
        step=0.1,
    ...
    petal_width = st.slider(
        ...
        value=float(feature_ranges["petal_width"].get("default", 1.2)),
        step=0.1,
...
if st.session_state.show_dataset_info:
    st.info("Dataset information is available once the model is loaded.")

if st.session_state.make_prediction:
    st.info("Prediction is ready when you press the Predict Species button.")
